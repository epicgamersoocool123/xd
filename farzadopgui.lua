...
library.theme = {
    ...
    titlesize = 18,
    font = Enum.Font.Code,
    background = "rbxassetid://6073763717",
    tilesize = 90,
    cursor = true,
    cursorimg = "https://t0.rbxcdn.com/42f66da98c40252ee151326a82aab51f",
    backgroundcolor = Color3.fromRGB(20, 20, 20),
    tabstextcolor = Color3.fromRGB(240, 240, 240),
    bordercolor = Color3.fromRGB(242, 243, 243),
    accentcolor = Color3.fromRGB(242, 243, 243),
    accentcolor2 = Color3.fromRGB(16, 31, 78),
    outlinecolor = Color3.fromRGB(242, 243, 243),
    outlinecolor2 = Color3.fromRGB(98, 37, 209),
    ...
    function window:CreateTab(name)
        ...
        function tab:CreateSector(name,side)
            ...
            function sector:AddSeperator(text)
                ...
                seperator.line.BackgroundColor3 = Color3.fromRGB(150, 150, 150)
